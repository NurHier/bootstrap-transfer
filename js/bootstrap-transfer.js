    ...
    return this.each(function(){
      ...
      _this.update_lists = function(force_hilite_off) {
        ...
        for (var i in lists) {
          for (var j in lists[i]) {
            ...
            if (e[1]) {
              ...
              source[i].append('<option class="selector-option" ' + selected + 'value=' + e[0].value + '>' + e[0].content + '</option>');
            }
          }
        }
        _this.$remaining_select.find('option').each(function() {
          ...
          if (outer.indexOf(inner) == -1) {
            _this.filtered_list.push($(this).val());
            $(this).remove();
          }
        })
      };
      ...
      _this.move_all = function(b1, b2) {
        for (var i in _this._remaining_list) {
          if(!_this.filtered_list.includes(_this._remaining_list[i][0].value)) {
          ...
          <tr>\
              <td width="50%">\
                  <div class="selector-available">\
                      <h2>待选列表</h2>\
                      <a href="javascript: void(0)" class="selector-chooseall">全选</a>\
                      <div class="selector-filter">\
              <div class="selector-search"><i class="icon-search"></i></div>\
              ...
              <td>\
                  <div class="selector-chooser">\
                      <a href="javascript: void(0)" class="selector-add" title="添加"><i class="icon-chevron-right icon-white"></i></a>\
                      <a href="javascript: void(0)" class="selector-remove" title="删除"><i class="icon-chevron-left icon-white"></i></i> </a>\
                  </div>\
              </td>\
              <td width="50%">\
                  <div class="selector-chosen">\
                      <h2>已选列表</h2>\
                      <a href="javascript: void(0)" class="selector-clearall">清空</a>\
                      <div class="selector-filter">\
                          <p>&nbsp;</p>\
                      </div>\
